  ...
  const handleSchedule = async () => {
    ...
    try {
      await api.post("/api/posts", {
        ...
        mediaUrl: activeScheduler.emdiaUrl,
    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-20 animate-in fade-in duration-700">
          ...
          {generations.length === 0 && (
            <div className="col-span-full py-20 text-center space-y-2">
              ...
              <p className="text-slate-400 text-sm">
                No content generated yet. Try generating some content using th
                AI.
              </p>
            </div>
          )}
      ...
      {activeScheduler && (
        <div className="fixed inset-0 min-h-screen z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-md animate-in fade-in duration-300">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl boredr border-slate-100 overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-8 bg-slate-50/50 border-t border-l-stone-50 space-y-8">
              {/* Options */}
