...
const Scheduler = () => {
  ...
  const handleSchedule = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Post validation failed: platform: Cast to string failed for value "[ 'linkedin' ]" (type Array) at path "platform"
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 h-full">
      ...
      <div className="w-full lg:w-[460px] shrink-0">
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          <div className="flex items-center gap-2 mb-6">
            <h2 className="text-lg-center text-slate-700">Compose Post</h2>
          </div>
          <form className="space-y-5" onSubmit={handleSchedule}>
            ...
            <div>
              ...
              {mediaFile ? (
                <div className="relative border overflow-hidden border-slate-200 bg-slate-50">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 scale-7 bg-slate-900/60 hover:bg-slate-900/80 text-white rounded-full flex items-center justify-center transition-colors"
                  >
                    <XIcon className="size-3.5" />
                  </button>
                </div>
              ) : (
                <label className="flex items-center justify-center gap-2 p-5 py-20 border-2 border-dashed border-slate-200 rounded-xl cursor-pointer hover:border-red-300 hover:bg-red-50/30 transition-all group">
      ...
      <div className="flex flex-1 flex-col gap-6 min-w-0">
        {/* Upcoming */}
        <div className="bg-white border-2xl border border-slate-200 overflow-hidden">
          <div className="flex items-center gap-2.5 px-5 py-4 border-b border-slate-100">
            <CalendarDaysIcon className="size-4 text-zinc-50" />
        ...
        <div className="bg-white border-2xl border border-slate-200 overflow-hidden">
          <div className="flex items-center gap-2.5 px-5 py-4 border-b border-slate-100">
            <SendIcon className="size-4 text-zinc-50" />
