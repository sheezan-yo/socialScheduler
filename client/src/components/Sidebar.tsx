    ...
    >
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.name}
              {isActive && (
                <span className="ml-auto w-[5px] rounded-full bg-red-500" />
              )}
            </NavLink>
          );
        })}
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-slate-50 transition-colors">
          <div className="size-8 rounded-full bg-linear-to-br from-red-400 to-pink-400 flex items-center justify-center text-white text-sm fontmedium shrink-0">
